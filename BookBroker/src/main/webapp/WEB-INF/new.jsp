...
<body>
    <div class="container justify-content-center col-8">
   		<div class="d-flex justify-content-around col-12"> 
			<h1 class=" my-4">ADD A BOOK TO YOUR SHELF!</h1>
			<p class="my-5"><a href="/bookmarket">BACK TO THE SHELVES</a></p>
		</div>
        <div class="form-group d-flex justify-content-center my-3">
			<form:form action="/books" mode="post" modelAttribute="book"  class="card col-8 p-4 mx-auto bg-dark shadow border border-light border-4 rounded rounded-3 text-light">
		        ...
		        <input type="submit" value="SUBMIT" class="btn btn-light text-center"/>
			</form:form>
		</div>
	</div>
</body>
