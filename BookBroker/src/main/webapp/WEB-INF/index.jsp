    ...
    <div class="container my-3">
		...
		<p class="p-3">A PLACE FOR FRIENDS TO SHARE THOUGHTS ON BOOKS.</p>
	        <div class="my-2 d-inline-block col-5">     		
				<form:form action="/register" mode="post" modelAttribute="newUser"  class="card p-4 mx-auto shadow border border-light bg-dark text-light border-4 rounded rounded-3">
	       		<h2 class="text-center p-3 bg-light text-dark"><strong>REGISTER</strong></h2>					
					<hr>
	        ...
	        <div class="my-2 d-inline-block col-5">
				<form:form action="/login" mode="post" modelAttribute="newLogin"  class="card p-4 mx-auto shadow border border-light bg-dark text-light border-4 rounded rounded-3">
					<h2 class="text-center p-3 bg-light text-dark"><strong>LOGIN</strong></h2>
					<hr>
					<div class="d-flex justify-content-between p-2">
				        <form:label path="email" class="form-label"><strong>EMAIL:</strong></form:label>
						<form:errors path="email" class="text-danger"/>
